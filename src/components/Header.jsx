      ...
      <nav className="max-w-8xl mx-auto px-4 py-4 flex flex-col  md:items-center md:justify-between">
        <div className="flex items-center justify-between w-full">
          ...
          <form className="flex flex-[2] w-full px-4">
            <div class="w-full max-w-[600px] min-w-[200px]">
              <div class="relative">
                <input
          ...
          <ul className="flex items-center space-x-4">
            ...
            <li className="relative group">
              ...
              <div className="hidden flex-col md:group-hover:flex animate-zoomInDown absolute left-0 md:left-auto md:right-0 mt-2 w-[92vw] md:w-[480px] max-w-[95vw] overflow-auto max-h-[90vh] bg-white shadow-lg border border-gray-200 rounded-md p-3 z-50">
                <h1 className="text-base font-bold">Order Summary</h1>
                <table class="w-full border-none table-auto pb-2">
                    <thead>
                      <tr className="flex justify-between items-center border-b pb-1">
                        <th className="text-sm text-gray-500">Product</th>
                        <th className="text-sm text-gray-500">Quantity</th>
